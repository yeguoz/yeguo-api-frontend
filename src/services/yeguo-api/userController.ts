...
/** 查询所有用户 POST /api/user/selectAll */
export async function userSelectAll(options?: { [key: string]: any }) {
  return request<API.ResponseData>('/api/user/selectAll', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function userUpdate(data:API.UserVO,options?: { [key: string]: any }) {
